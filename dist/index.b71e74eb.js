...
})({"hziyJ":[function(require,module,exports) {
...
var _aBPruning = require("./a-b-pruning");
console.log("ALPHA BETA");

},{"./a-b-pruning":"jypeP"}],"jypeP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "alphaBetaSearch", ()=>alphaBetaSearch);
class TreeNode {
    constructor(utility, actions, depth){
...
function maxValue(node, alpha, beta) {
    ...
    for(let i = 0; i < node.actions.length; ++i){
        ...
        if (maybeBetterVal > bestVal) {
            ...
            if (bestVal >= node.beta) return [
                bestVal,
                node.nextify(bestMove)
            ];
...
function convert(action, depth = 0) {
    const node = new TreeNode(action.utility, action.actions?.map((action)=>convert(action, depth + 1)) ?? [], depth);
    return node;
}
const node = convert({
    utility: 3,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"g1KRP"}],"g1KRP":[function(require,module,exports) {
...
},{}]},["hziyJ","h7u1C"], "h7u1C", "parcelRequirefd98")
